...
export const SPECIALTIES: SpecialtyMeta[] = [
  ...
  { value: "terapeuta_ocupacional",label: "Terapeuta Ocupacional",  color: "#1E90FF", fg: "#FFFFFF" }, // azul
...
export const specialtyMap: Record<Specialty, SpecialtyMeta> =
  Object.fromEntries(SPECIALTIES.map((s) => [s.value, s])) as any;
